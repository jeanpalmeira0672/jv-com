...
<head>
    ...
    <title>FéNotebooks.com - Gamer</title>
...
<body>
    ...
    <section class="category-hero" style="background-image:url('images/bg-gamer.jpg')">
        ...
        <div class="container category-hero__content">
            <h1>Gamer</h1>
            <p>Potência e performance para suas jogatinas.</p>
        </div>
    </section>
    ...
    <main class="container">
        ...
        <section id="products" class="products">
            <h2 class="section__title">Notebooks Gamer</h2>
            <div class="layout--with-sidebar">
                ...
                <div class="products__grid">
                    <?php foreach ($produtos as $p): ?>
                        <article class="card">
                            <img
                                src="<?= $imgBase . htmlspecialchars($p['imagem'], ENT_QUOTES) ?>"
        ...
        <div class="pagination">
            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <a href="?page=<?= $i ?>&min_price=<?= htmlspecialchars($_GET['min_price'] ?? '') ?>&max_price=<?= htmlspecialchars($_GET['max_price'] ?? '') ?>"
                    class="<?= ($i == $page) ? 'active' : '' ?>">
                    <?= $i ?>
                </a>
            <?php endfor; ?>
